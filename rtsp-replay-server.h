...
#define GST_TYPE_RTSP_MEDIA_FACTORY_REPLAY                                     \
  (gst_rtsp_media_factory_replay_get_type())
G_DECLARE_FINAL_TYPE(GstRTSPMediaFactoryReplay, gst_rtsp_media_factory_replay,
